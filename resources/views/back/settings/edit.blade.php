                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="website_title"
                                                        class="required">{{ __('Website Title') }}:</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="card">
                                                            <div class="card-body text-center">
                                                                <div class="form-group">
                                                                    <label for="website_title"
                                                                        class="required">{{ __('Website Logo Transparent') }}:</label>
                                                                    <div class="">
                                                                        @if (!empty($setting->website_logo_light))
                                                                            <img src="{{ asset("images/settings/$setting->website_logo_light") }}"
                                                                                alt="..." id="website_logo_light"
                                                                                class="img-thumbnail rounded mb-3">
                                                                        @else
                                                                            <img src="" alt="..."
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="about" id="about" class="form-control @error('about') form-control-error @enderror"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="who_we_are" id="who_we_are" class="form-control @error('who_we_are') form-control-error @enderror"
                                                        rows="5">{{ $setting->who_we_are }}</textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="hotline" id="hotline"
                                                        class="form-control @error('hotline') form-control-error @enderror"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="email1" id="email"
                                                        class="form-control @error('email1') form-control-error @enderror"
                                            ...
                                            <div>
                                                ...
                                                <div class="col-md-6 p-2 mx-auto">
                                                    <div class="create-btn pull-right">
                                                        <button type="submit"
                                                            class="btn btn-primary btn-block">{{ __('Update Settings') }}</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- /card finish -->
